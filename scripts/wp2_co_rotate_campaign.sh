...
# ABORT if a round yields no trials. The first version of this script logged
# "no valid trials" 14 times and kept going: a MOD_VERSION bump mid-campaign
# tripped the loop's identity gate and rounds 2-8 produced nothing, burning ~1 h.
# A driver that cannot tell "the experiment is dead" from "an unlucky round"
# will happily run all night on nothing.
