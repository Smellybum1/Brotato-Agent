...
The current `0.2.9-wp2-capture` build preserves every existing v1 event and
summary field and executes policy `teacher_v1-0.1.101-gun-wp1`. Historical
`0.2.0` / v92 through `0.2.8` / v100 captures use the same extension. Instrumented runs
