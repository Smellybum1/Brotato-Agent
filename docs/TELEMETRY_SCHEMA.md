...
The current `0.2.2-wp2-capture` build preserves every existing v1 event and
summary field and executes policy `teacher_v1-0.1.94-gun-wp1`. Historical
`0.2.0` / v92 and `0.2.1` / v93 captures use the same extension. Instrumented runs
