...
The current `0.2.15-wp2-capture` build preserves every existing v1 event and
summary field and executes policy `teacher_v1-0.1.107-gun-wp1`. Historical
`0.2.0` / v92 through `0.2.14` / v106 captures use the same extension. Instrumented runs
