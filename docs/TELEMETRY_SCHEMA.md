...
The current `0.2.17-wp2-capture` build preserves every existing v1 event and
summary field and executes policy `teacher_v1-0.1.109-gun-wp1`. Historical
`0.2.0` / v92 through `0.2.16` / v108 captures use the same extension. Instrumented runs
